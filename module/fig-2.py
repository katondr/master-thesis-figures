...
#axs[2].text(1, 0.5, "$\it{luxI}$", transform=axs[2].transAxes, size=9, va='top', ha='right')
#axs[2].text(0.84, 0.5, "putative RBS", transform=axs[2].transAxes, size=9, va='top', ha='center')
#axs[2].text(0.7, 0.5, "TS", transform=axs[2].transAxes, size=9, va='top', ha='center')
#axs[2].text(0.58, 0.5, "-10", transform=axs[2].transAxes, size=9, va='top', ha='center')
#axs[2].text(0.18, 0.5, "luxR binding site", transform=axs[2].transAxes, size=9, va='top', ha='center')
...
#axs[2].text(0, 0.75, "(c)", transform=axs[2].transAxes, size=9, va='top', ha='left')

fig.tight_layout()
#fig.savefig('../figure/promoter-region.pdf', bbox_inches='tight')
fig.savefig('../figure/fig-2.png', dpi=300, bbox_inches='tight', transparent=True)
